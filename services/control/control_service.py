"""Orquestacion del flujo de control (SCR), Sprint 6 -- F26 (solicitud),
F27 (aprobacion) y la parte de F28 que corresponde a este sprint
(validar que una orden esta lista para ejecutar). El envio real al
adaptador HES (F29) y la confirmacion de estado post-ejecucion (F30,
resto) son Sprint 7 -- no se tocan aca.
